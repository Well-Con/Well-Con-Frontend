  ...
  return (
    <div className="flex flex-col  w-screen  min-h-screen bg-gradient-to-r from-white-200 to-white-200 py-[50px]">
      ...
      <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={handleSubmit}>
          ...
          <input required minLength={10} pattern="^[0-9]+$" type="text" placeholder="Phone Number" className="input p-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500" name='phoneNo' value={data.phoneNo} onChange={handleChange} />
