...
//                 <i className="fa-brands fa-slack text-green-500 fa-lg logo "></i>
...
//                 }
//             >
//                 <i className="fa-solid fa-user profile icon profile"></i>
...
const Sidebar = () => {
    ...
    return (
        <>
            <div
                className={`sidebar ${closeMenu ? "active" : ""}`}
            >
                {/* Logo */}
                ...
                {/* Toggle */}
                <div
                    className={`burgerContainer ${closeMenu ? "active" : ""}`}
                >
                    <div
                        className="burgerTrigger"
                    ...
                    <ul>
                        ...
                        <li className={location.pathname === "/appointments" ? "active" : ""}>
                            ...
                            <a href="/appointments">
                                <i className="fa-solid fa-calendar-check icon"></i>
                                &nbsp;&nbsp;
                                <p className='link-text'>Appointments</p>
                            </a>
                        </li>
